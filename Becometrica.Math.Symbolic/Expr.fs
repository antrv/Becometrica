...
type Expr =
    ...
    static member OfInteger(integer: bigint) = new MpInteger(integer) |> IntegerExpr
    static member OfInteger(integer: MpInteger) = IntegerExpr integer
    static member OfRational(rational: MpRational) = rational |> RationalExpr
    static member OfRational(numerator: MpInteger, denominator) = new MpRational(numerator, denominator) |> RationalExpr
    ...
    static member op_Implicit(rational: MpRational) = Expr.OfRational rational
