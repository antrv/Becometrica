...
/// <summary>
/// The structure represents an unmanaged pointer to an UTF-8 encoded zero-terminated string.
    ...
    IEquatable<ConstPtr<byte>>, IEquatable<nint>, IEquatable<nuint>
{
    ...
    public static unsafe Utf8StringPtr Create(byte* ptr) => new((Ptr<byte>)ptr);
    ...
    public override bool Equals(object? obj) => obj switch
    {
        ...
        IGenericPtr genericPtr => _ptr == genericPtr.ToNativeInt(),
        _ => false,
    };
