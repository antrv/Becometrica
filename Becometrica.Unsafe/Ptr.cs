...
public readonly struct Ptr<T>: IPtr<Ptr<T>, T>, IEquatable<ConstPtr<T>>, IEquatable<nint>, IEquatable<nuint>
    where T: unmanaged
{
    ...
    public static implicit operator Ptr<T>(NullPtr ptr) => new(default(nint));
