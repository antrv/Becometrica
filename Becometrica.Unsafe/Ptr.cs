    ...
    where T: unmanaged
{
    ...
    public unsafe Span<T> AsSpan(int length) => new((T*)_ptr, length);
    ...
    public unsafe Ptr<T> Add(nint offset) => new((T*)_ptr + offset);
    public unsafe Ptr<T> Add(long offset) => new((T*)_ptr + offset);
    public unsafe Ptr<T> Subtract(int offset) => new((T*)_ptr - offset);
    public unsafe Ptr<T> Subtract(nint offset) => new((T*)_ptr - offset);
