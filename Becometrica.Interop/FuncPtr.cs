    ...
    where TResult: unmanaged
{
    ...
    public unsafe FuncPtr(Func<TArg1, TArg2, TArg3, TArg4, TResult>? func)
    {
        if (func is null)
            _ptr = default;
        else if (func.Target is not null)
            throw new ArgumentException("The delegate must be static.", nameof(func));
        else
            _ptr = (delegate*<TArg1, TArg2, TArg3, TArg4, TResult>)Marshal.GetFunctionPointerForDelegate(func);
    }
    ...
    public static implicit operator FuncPtr<TArg1, TArg2, TArg3, TArg4, TResult>(
        Func<TArg1, TArg2, TArg3, TArg4, TResult>? func) => new(func);
...
{
    public static FuncPtr<TArg1, TArg2, TArg3, TArg4, TResult> Create<TArg1, TArg2, TArg3, TArg4, TResult>(
